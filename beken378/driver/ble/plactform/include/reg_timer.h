...
__INLINE uint8_t tmr_enable_getf(void)
{
    ...
    BLE_ASSERT_ERR((localVal & ~((uint32_t)0x00000001)) == 0);
    return (localVal >> 0);
}

__INLINE void tmr_enable_setf(uint8_t enable)
{
    BLE_ASSERT_ERR((((uint32_t)enable << 0) & ~((uint32_t)0x00000001)) == 0);
...
__INLINE uint32_t tmr_time_getf(void)
{
    ...
    BLE_ASSERT_ERR((localVal & ~((uint32_t)0x00FFFFFF)) == 0);
    return (localVal >> 0);
}
...
{
    BLE_ASSERT_ERR((((uint32_t)gross << 0) & ~((uint32_t)0x00FFFFFF)) == 0);
...
{
    BLE_ASSERT_ERR((((uint32_t)expire << 0) & ~((uint32_t)0x00000001)) == 0);
