...
__INLINE void ble_txcntl_pack(int elt_idx, uint8_t txdone, uint16_t nextptr)
{
    ...
    BLE_ASSERT_ERR((((uint16_t)nextptr << 0) & ~((uint16_t)0x00007FFF)) == 0);
...
{
    BLE_ASSERT_ERR((((uint16_t)freebuff << 15) & ~((uint16_t)0x00008000)) == 0);
    BLE_ASSERT_ERR((((uint16_t)fragcnt << 8) & ~((uint16_t)0x00000F00)) == 0);
    BLE_ASSERT_ERR((((uint16_t)buffidx << 0) & ~((uint16_t)0x000000FF)) == 0);
