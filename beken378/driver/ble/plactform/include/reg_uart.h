...
{
    BLE_ASSERT_ERR((((uint32_t)threshold << 0) & ~((uint32_t)0x000000FF)) == 0);
...
{
    BLE_ASSERT_ERR((((uint32_t)threshold << 8) & ~((uint32_t)0x0000FF00)) == 0);
...
{
    BLE_ASSERT_ERR((((uint32_t)time << 9) & ~((uint32_t)0x00010000)) == 0);
...
{
    BLE_ASSERT_ERR((((uint32_t)forcerts << 16) & ~((uint32_t)0x00010000)) == 0);
...
{
    BLE_ASSERT_ERR((((uint32_t)cnt << 0) & ~((uint32_t)0x000000FF)) == 0);
...
{
    BLE_ASSERT_ERR((((uint32_t)cnt << 8) & ~((uint32_t)0x0000FF00)) == 0);
...
{
    BLE_ASSERT_ERR((((uint32_t)rts << 17) & ~((uint32_t)0x00010000)) == 0);
...
{
    BLE_ASSERT_ERR((((uint32_t)cts << 18) & ~((uint32_t)0x00020000)) == 0);
...
{
    BLE_ASSERT_ERR((((uint32_t)wakernel_up << 7) & ~((uint32_t)0x00000080)) == 0);
